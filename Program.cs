...
class Program
{
    static void Main(string[] args)
    {
        while (true)
        {
            ...
            if (int.TryParse(input, out int temperatureCelsius))
            {
                ...
                switch (temperatureCelsius)
                {
                    case <= 0:
                        ...
                        Console.WriteLine($"It's freezing cold outside. ({temperatureCelsius}°C / {temperatureFahrenheit:F1}°F)");
                        Console.ResetColor();
                        break;

                    case > 0 and <= 15:
                        Console.ForegroundColor = ConsoleColor.Cyan;
                        Console.WriteLine($"It's pretty chilly outside.({temperatureCelsius}°C / {temperatureFahrenheit:F1}°F)");
                        Console.ResetColor();
                        break;

                    case > 15 and <= 25:
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine($"The weather is mild and comfortable.({temperatureCelsius}°C / {temperatureFahrenheit:F1}°F)");
                        Console.ResetColor();
                        break;

                    case > 25 and <= 35:
                        Console.ForegroundColor = ConsoleColor.Yellow;
                        Console.WriteLine($"It's pretty hot, but still comfortable outside.({temperatureCelsius}°C / {temperatureFahrenheit:F1}°F)");
                        Console.ResetColor();
                        break;

                    case > 35 and <= 45:
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine($"It's very very hot outside.({temperatureCelsius}°C / {temperatureFahrenheit:F1}°F)");
                        Console.ResetColor();
                        break;

                    case > 45:
                        Console.ForegroundColor = ConsoleColor.DarkRed;
                        Console.WriteLine($"It's dangerous to be outside too long.({temperatureCelsius}°C / {temperatureFahrenheit:F1}°F)");
                        Console.ResetColor();
                        break;
                }
            }
